...
async function writePackageJson() {
  ...
  if (!libExists) {
    console.error('@ReyEndymion/scraper:', 'Lib folder not found after compiling TypeScript')
    process.exit(1)
  }
  console.log('@ReyEndymion/scraper:', 'Writing \'package.json\' file...')
  ...
  } else console.warn('@ReyEndymion/scraper:', 'CJS folder not found')
  ...
  } else console.warn('@ReyEndymion/scraper:', 'ESM folder not found')
  ...
  if (!typesExists && !libEsmExists && !libCjsExists) {
    console.error('@ReyEndymion/scraper:', 'No compiled TypeScript files found')
    process.exit(1)
  }
}
