...
export const listJadwalTV: Promise<ListJadwalTV> = (async () => await got('https://raw.githubusercontent.com/reyendymion/scraper/master/data/jadwal-tv.json').json<ListJadwalTV>())()
