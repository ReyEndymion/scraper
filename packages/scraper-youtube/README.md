...
## Installation
```sh
npm i @reyendymion/scraper-youtube
```
...
```ts
// import module
import { youtubedl } from '@reyendymion/scraper-youtube'
...
```
[Documentation](https://ReyEndymion.github.io/scraper/modules/_ReyEndymion_scraper_youtube.html)
